...
# Box 데이터
    ...
    # Box 데이터 (10도 상향)
box_data = {
    'P_A+': [(-0.17, 0.1),(0.17, 0.1),(0.17, 0.3),(-0.17, 0.3)],
    'P_A': [(-0.34, 0), (0.34, 0), (0.32, 0.48), (-0.32, 0.48)],
    'D_A+': [(0.82, 0.06), (0.82, 0.18),(0.70, 0.22), (0.71, 0.07)  ],
    'D_A': [(0.86, 0), (0.85, 0.28), (0.62, 0.40), (0.64, 0) ]}
